...
<body>
<form action="modify_menu_publisher.php" method="post">
<h2 align="center">WELCOME TO BOOK-4-U DATABASE</h2>
<table width="800" height="63" border="5" align="center" bgcolor="#CC66FF">
<tr>
...
while($row = mysqli_fetch_array($run))
{
	...
	<tr>
		...
		<td align="center">
			<a href="modify_publisher.php"><input type="button" name="modify" value="Modify" /></a>
		</td>
	</tr>
<?php } ?>
<tr>
