...
$conn = new mysqli('localhost',$user,$pass,$db) or die ('error in database connection');
		if(isset($_GET['delete']))
		{
			...
			$que = "delete from book where book_id = '$delete_record'";
...
<table width="1000" height="63" border="5" align="center" bgcolor="#CC66FF">
<tr>
...
<tr align="center" bgcolor="#FFFFCC">
	...
	<td align="center"><b>Delete Record</b></td>
</tr>
...
while($row = mysqli_fetch_array($run))
{
	...
	<tr>
		...
		<td align="center">
			<a href="delete_book.php?delete=<?php echo $book_id;?>"><input type="button" name="delete" value="Delete" /></a>
		</td>
	</tr>
<?php } ?>
<tr>
